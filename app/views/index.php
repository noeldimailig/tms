            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-start">
                        ...
                        <p class="mb-5"><a class="btn btn-sm btn-danger" href="<?= site_url('pages/choose'); ?>">Sign up Now!</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid padding" >
      <div class="row padding">
        ...
        <br><br><br>
          ...
          <a href="<?php if(!isset($_SESSION['user_email'])) echo site_url('pages/login'); else echo site_url('archive/index'); ?>" class="btn btn-outline-secondary">Go to</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container-fluid padding" >
      <div class="row padding">
        ...
        <br><br><br><br>
          ...
          <a href="<?php if(!isset($_SESSION['user_email'])) echo site_url('pages/login'); else echo site_url('classes/index'); ?>" class="btn btn-outline-secondary">Go to</a>
        </div>
        <div class="col-lg-4">
    ...
    <div class="container-fluid padding" >
      <div class="row padding">
        ...
        <br><br><br><br>
          ...
          <a href="<?php if(!isset($_SESSION['user_email'])) echo site_url('pages/login'); else echo site_url('conference/index'); ?>" class="btn btn-outline-secondary">Go to</a>
        </div>
      </div>
    </div>
  </div>
