                    ...
                    <div class="col-lg-12 d-flex align-items-start justify-content-between border border-light rounded p-0">
                        <div class="col-lg-3 col-md-2 col-sm-12 p-3 bg-light rounded-start">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center">
                                ...
                                <p class="fs-6 text-secondary"><span class="mx-2 text-success"><i class="fas fa-school"></i></span><?= $data['designation']; ?></p>
                                    ...
                                    <form class="needs-validation" action="<?php echo site_url('account/update_account_details'); ?>" class="px-3" style="width:922px;height:auto;" method="post" id="a-details">
                                        ...
                                        <div class="col-12 d-flex flex-column align-items-center justify-content-center">
                                            ...
                                            <div class="col-lg-6 mb-2">
                                                <label class="form-label mb-0" for="designation" class="form-label mb-0">Salutation</label>
