    ...
    <div class="container-fluid">
        <div class="row p-5 my-4 rounded-3">
            ...
            <div class="col-md-6">
                ...
                <form id="signin-validate" class="needs-validation" action="<?= site_url('account/signin'); ?>" method="post" data-hs-cf-bound="true">
                    ...
                    <div class="text-center mb-3 d-flex align-items-between justify-content-between fs-6">
                        <a class="btn btn-link" href="<?= site_url('pages/verify'); ?>"><span>Verify Account</span></a>
                        <a class="btn btn-link" href="<?= site_url('pages/forgot'); ?>"><span>Forgot password?</span></a>
                    </div>
                    <div class="form-group col-12 mb-3">
                ...
                <div class="signup-container text-center">
                    <span class="qa-test-login-signup-link">Don't have an account? <a href="<?= site_url('pages/choose'); ?>"> Sign up </a></span>
                </div>
            </div>
        </div>
    </div>
