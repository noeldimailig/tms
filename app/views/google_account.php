...
<body>
    <nav class="navbar navbar-expand-lg bg-success p-4 fixed-top">
        <div class="container-fluid d-flex align-items-center justify-content-center">
            <a href="<?= site_url('pages/index'); ?>" class="navbar-brand fs-3 text-white">Thesis Management System</a>
        </div>
    </nav>
    <div class="container-fluid">
        <div class="row p-5 my-4">
            ...
            <div class="col-md-6 d-flex flex-column align-items-center justify-content-center p-5 bg-light border border-light rounded-3">
                ...
                <a class="btn btn-lg btn-success" href="<?= site_url('account/google'); ?>">Proceed</a>
            </div>
            <div class="col-md-3"></div>
        </div>
    </div>
