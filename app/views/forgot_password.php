    ...
    <div class="container-fluid">
        <div class="row p-5 my-4 rounded-3">
            ...
            <div class="col-md-6">
                ...
                <form id="forgot-validate" class="needs-validation" action="<?= site_url('account/forgot_password'); ?>" method="post">
                ...
                <div class="d-flex align-items-between justify-content-between fs-6">
                    <a href="<?= site_url('pages/login'); ?>">Sign In</a>
                    <a href="<?= site_url('pages/choose'); ?>">Sign Up</a>
                </div>
            </div>
        </div>
    </div>
