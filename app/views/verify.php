...
<body>
    ...
    <div class="container-fluid">
        <div class="row p-5 my-4 rounded-3">
            ...
            <div class="col-md-7">
                <a class="fs-5 mt-5" style="text-transform:none;" href="<?= site_url('pages/login'); ?>"><i class="fa-solid fa-arrow-left-long fa-lg text-dark"></i> Go Back</a>
                ...
                <div id="message"></div>
                <form id="verify-validate" class="needs-validation" action="<?= site_url('account/verify_account'); ?>" method="post">  
